...
# ===== IDE 检测元数据（从 ide.yaml 加载） =====
# 配置数据源：scripts/lib/ide/ide.yaml（detect_meta 段）
# 代码只负责调用执行，新增/修改 IDE 请编辑 ide.yaml
from ._meta import get_detect_meta as _get_detect_meta

IDE_DETECT_META = _get_detect_meta()
